...
const Index = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const mailtoUrl = `mailto:reddyparasannaguntimadugu@gmail.com?subject=${subject}&body=${body}`;
  ...
  const projects = [
    ...
    },
    {
      ...
      description:  "A full-stack web application for organizing and managing events, including event creation, participant registration, and scheduling. Developed using React, Spring Boot, and MySQL to provide a seamless and responsive user experience.",
  ...
  const experiences = [
    {
      title: "Vyuha Team Member",
      description: "Organized and led innovation-focused events for first-year students as part of the Vyuha initiative. Coordinated workshops, mentored student teams, and guided them through entrepreneurial project development, fostering creativity and leadership.",
      icon: "🏫",
      date: "2024-Present"
    },
   
    {
      title: "Prodigy Infotech-Python Programming Intern",
      description: "Completed a hands-on internship focused on core Python programming. Gained practical experience in writing Python scripts, working with data structures, and building logic-driven mini-projects.",
      icon: "🎓",
      date: "May - Jun 2025"
    },
    {
      title: "AWS Data Engineering virtual Internship",
      description: "Completed a 10-week virtual internship focused on full-stack web development. Gained hands-on experience with HTML, CSS, JavaScript, Java, Spring Boot, and MySQL. Explored industry best practices and applied modern development techniques in real-world projects.",
      icon: "💻",
  ...
  const certificates = [
    
    {
      ...
      date: "Apr - Jun 2025",
      description: "Completed a 10-week intensive internship focused on full-stack web development. Acquired hands-on experience with technologies like HTML, CSS, JavaScript, Java, Spring Boot, and MySQL, while gaining practical insights into modern industry practices and their application in real-world scenarios.",
      skills:["HTML", "CSS", "Bootstrap", "JavaScript", "Java", "Spring Boot", "MySQL", "AWS S3", "AWS Lambda", "AWS RDS"],
      imageUrl: AWSInternship
    },
    {
      title: "TCS Codevita Season-12",
      issuer: "TATA",
      date: "April 2024",
      description: "Participated in TCS CodeVita Season-12, a global coding competition organized by Tata Consultancy Services. Solved algorithmic challenges under time constraints, enhancing problem-solving skills and proficiency in data structures and algorithms.",
      skills: ["Problem Solving", "Algorithms", "Data Structures", "Java", "Python"],
      imageUrl: TCS
    },
    {
      title: "Introduction To Mern",
      issuer: "SimplyLearn SkillUp",
      date: "Dec 2024",
      description: "Completed an introductory workshop on the MERN stack (MongoDB, Express.js, React.js, and Node.js). Gained foundational understanding of building full-stack web applications and integrating frontend with backend services.",
    ...
    },
     {
      ...
      date: "NOV 2024",
      description:  "Completed a comprehensive course on the Python stack covering core Python programming, object-oriented concepts, data structures, file handling, and foundational web development with Flask.",
      skills: ["Python", "OOP", "Data Structures", "File Handling", "Flask", "Backend Development"],
      imageUrl: Python
    },
    {
      title: "AI Associate",
      issuer: "Salesforce",
      date: "Oct 2024",
      description:"Completed an AI Associate certification program covering the fundamentals of Artificial Intelligence, including supervised and unsupervised learning, machine learning algorithms, and real-world applications using Python.",
      skills: ["Artificial Intelligence", "Machine Learning", "Python", "Supervised Learning", "Unsupervised Learning", "Data Analysis"],
      imageUrl: AI
    },
    {
      ...
      date: "Jul 2025",
      description:"Completed an in-depth course on Data Structures and Algorithms, covering time and space complexity analysis, arrays, linked lists, stacks, queues, trees, graphs, sorting and searching techniques, dynamic programming, and problem-solving strategies in Java.",
      skills: ["Data Structures", "Algorithms", "Problem Solving", "Time Complexity", "Java", "Dynamic Programming", "Sorting", "Graphs"],
      imageUrl: code360
    },
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <Card className="text-center p-6 hover:shadow-lg transition-all duration-300 border-2 hover:border-primary/50">
                <CardContent className="p-0">
                  ...
                  <p className="text-sm text-muted-foreground">HTML, CSS, JavaScript, React, Spring Boot, MySQL, MongoDB, Git, GitHub, TailwindCSS, Data Science</p>
                </CardContent>
              </Card>
              <Card className="text-center p-6 hover:shadow-lg transition-all duration-300 border-2 hover:border-primary/50">
                <CardContent className="p-0">
                  ...
                  <p className="text-sm text-muted-foreground">Actively looking for internships and Jobs in the field of Software Development, and Web Development.</p>
                </CardContent>
              </Card>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
              {/* CodeChef */}
              <a
                href="https://www.codechef.com/users/klu_2300033100"
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">klu_2300033100</div>
                </div>
              </a>
              {/* LeetCode */}
              <a
                href="https://leetcode.com/u/klu2300033100/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">klu2300033100</div>
                </div>
              </a>
              {/* HackerRank */}
              <a
                href="https://www.hackerrank.com/profile/klu2300033100"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <CardContent className="p-0">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <p className="text-xs text-muted-foreground text-center">
                    This will open your default email client with a pre-filled message to reddyprasannaguntimadugu@gmail.com
                  </p>
                </form>
              </CardContent>
            </Card>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="flex flex-col gap-7 justify-center items-center mb-10">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col items-start">
                  ...
                  >
                    reddyprasannaguntimadugu@gmail.com
                  </a>
                </div>
              </div>
              {/* College Email */}
            ...
            <footer className="text-center text-muted-foreground border-t pt-8 mt-10">
              <p>© 2025 ReddyPrasanna. All rights reserved.</p>
            </footer>
          </div>
        </div>
      </section>
